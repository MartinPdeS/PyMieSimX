    ...
    return html.Section(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    html.Div(id="single-nearfield-availability-alert", className="nearfield-availability-alert", style={"display": "none"}),
                    html.Div(
                        ...
                        children=[
                            ...
                            html.Div(className="field-block sampling-field", children=[html.Label("Angular sampling", htmlFor="single-sampling"), dcc.Input(id="single-sampling", type="text", inputMode="numeric", value=str(DEFAULT_WORKSPACE_SETTINGS["particle_explorer"]["sampling"]), placeholder=str(DEFAULT_WORKSPACE_SETTINGS["particle_explorer"]["sampling"]), debounce=True, className="field-input", persistence=True, persistence_type="session")]),
                        ],
                    ),
                    html.Div(
